...
urlpatterns = [
    ...
    path('datatable/trx/', login_required(views.datatable_trx), name='datatable_trx'),
    ...
    url(r'^datatable/data/trx/$', login_required(views.datatableview_trx.as_view()), name='datatable-data-trx'),
